...
Scope: review changes under `client/` only. Treat `client/src/generated/*` as generated code; do not request manual edits there unless generation is clearly out of sync with source contracts.
