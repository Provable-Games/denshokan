...
- Review only changes outside `contracts/**`, `indexer/**`, `api/**`, and `client/**` (CI configs, docs, scripts, tooling, etc.).
- Do not raise findings for Cairo contract code, TypeScript indexer/API code, or React client code — those are handled by specialized reviews.
